...
const BorrowedBook = () => {
  ...
  const handleDelete = (objectId,id, quantity) => {
    ...
    axios
      .put(`http://localhost:5000/books/${objectId}`, {
  ...
  return (
    ...
    {
      borrowed.length ? <Container className="md:py-16">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {borrowed?.map((borrow) => (
          ...
          >
            ...
            <button
              onClick={() => handleDelete(borrow.objectId,borrow._id, borrow.book_quantity)}
    ...
    <div className="h-[90vh] flex justify-center items-center">
      <h2 className="text-3xl md:text-6xl py-6 font-bold text-primary-content text-center">No Book Borrowed</h2>
    </div>
    }
    </>
  );
