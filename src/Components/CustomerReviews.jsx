    ...
    <div className=" bg-accent bg-opacity-50 py-10 rounded-lg">
      ...
      >
      {
        reviews?.map(review =>  <SwiperSlide key={review._id} >
            ...
            <img src={review.image} className="rounded-full border-4 border-white w-24 h-24 object-cover" />
            <h2 className="text-center font-bold text-3xl md:text-5xl">{review.name}</h2>
