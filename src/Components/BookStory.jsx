...
const BookStory = () => {
    ...
    return (
       ...
       >
            ...
            <button onClick={() => generatePDF(target, options,  {filename: 'page.pdf'})} className="  bg-primary hover:bg-blue-600 text-white rounded py-2 px-4 focus:outline-none transition-transform hover:scale-105">Download PDF</button>
            </div>
